...
const DesignoFooter = ({
    ...
    hasGetInTouch?: boolean
}) => {
    return (
        <div className={Styles.dsgn__footer} style={!hasGetInTouch ? { marginTop: 0 } : {}}>        
            <div className={`d-flex justify-content-between align-items-center`}>
                <div style={{ width: 196, height: 24 }}>
                    <img src='/designo-multi-page/shared/desktop/logo-light.png' alt='Designo Logo' />
                </div>
                <nav>
                    <ul className='d-flex align-items-center m-0 p-0' style={{ gap: 42, listStyle: 'none' }}>
                        <li className={Styles.navLink} data-nav="dark">
            ...
            <hr style={{ margin: '40px 0px 31px', borderColor: '#979797' }} />
            <div className={Styles.dsgn__footer_slin}>
                <div className='d-flex flex-column'>
                    <span className='fs16 lh-26 fw-700'>
                        Designo Central Office
                    </span>
                    <span className='fs16 lh-26'>
                ...
                <div className='d-flex flex-column'>
                    ...
                    <a href="tel:+1 253-863-8967" className='fs16 lh-26 fw-700'>
                        P : +1 253-863-8967
                    </a>                    
                    <a href="mailto:contact@designo.co" className='fs16 lh-26 fw-700'>
                        M : contact@designo.co
                    </a>
                </div>
                <div className='d-flex align-items-end justify-content-end' style={{gap: 16 }}>
